      ...
      <div id='appeteasers' >
        <div className="section white">
          <div className="row container" style={{marginBottom: 0}} >
            <h2 className="header" style={{fontFamily: 'Parisienne, cursive', fontStyle: 'italic', marginBottom: 0 }}>{Data.categorys[1].name}</h2>
        ...
        <div className='container'>
          ...
          <ProductSlider data={Data.categorys[1]['menu-items']} styleClass = {'dark-slider'} />
        </div>        
