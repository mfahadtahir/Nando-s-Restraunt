      ...
      <div id='sides' >
        <div className="section white">
          <div className="row container" style={{marginBottom: 0}} >
            <h2 className="header" style={{fontFamily: 'Parisienne, cursive', fontStyle: 'italic', marginBottom: 0 }}>{Data.categorys[5].name}</h2>
        ...
        <div className='container'>
          ...
          <ProductSlider data={Data.categorys[5]['menu-items']} styleClass = {'dark-slider'} />
        </div>        
