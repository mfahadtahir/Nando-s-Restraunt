    ...
    return(
      ...
      <div className="navbar-fixed" >
        <nav className='black-text ' style={{backgroundColor: this.state.background, boxShadow: 'none'}}>
          <div className="nav-wrapper" >
            ...
            <ul className="right hide-on-med-and-down" style={{color: this.state.color}} >
              ...
              <li><a style={{color: this.state.color, fontWeight: "bold"}} href="#top">About us</a></li>
              <li><a style={{color: this.state.color, fontWeight: "bold"}} href="#top">Menu</a></li>
              <li><a style={{color: this.state.color, fontWeight: "bold"}} href="#top">Reservation</a></li>
              <li><a style={{color: this.state.color, fontWeight: "bold"}} href="#footer">Contacts</a></li>
        ...
        <ul className="sidenav" id="mobile-demo">
          ...
          <li><a href="badges.html">Reservation</a></li>
